...
export const Input = forwardRef<IInputFunctions, IInput>(({labelText, datalist, name, id, inputType="text", required, type }, ref): JSX.Element => {
	...
	return (
		<div className={`block_input ${error ? "incorrect-value" : ""}`} data-selector="input-block">
			<label htmlFor={id}>{labelText}{required && <span aria-label="This is required field"> *</span>}</label>
